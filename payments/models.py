...
class Payment(models.Model):
    ...
    METHOD_CHOICES = [
        ...
        ("e_wallet", "E-Wallet"),
        ("cash", "Cash"),
        # allow QRIS for compatibility with legacy tests
        ("qris", "QRIS"),
    ]
    ...
    class Meta:
        ...
        constraints = [
            models.CheckConstraint(
                check=models.Q(amount__gt=0), name="check_positive_amount"
            ),
            models.CheckConstraint(
                check=models.Q(refunded_amount__isnull=True)
                | models.Q(refunded_amount__gt=0),
